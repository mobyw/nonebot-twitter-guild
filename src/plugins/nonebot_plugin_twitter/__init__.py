...
from nonebot.adapters.onebot.v11 import Bot, Message, GroupMessageEvent, GroupDecreaseNoticeEvent
...
adduser = on_command('推特关注', priority=5, permission=GROUP_ADMIN |
                     GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER, )
...
removeuser = on_command('推特取关', priority=5, permission=GROUP_ADMIN |
                        GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER,)
...
alllist = on_command('推特列表', priority=5, permission=GROUP_ADMIN |
                     GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER,)
...
ontranslate = on_command('开启翻译', priority=5, permission=GROUP_ADMIN |
                         GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER,)
...
offtranslate = on_command('关闭翻译', priority=5, permission=GROUP_ADMIN |
                          GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER,)
...
help = on_command('推特帮助', priority=5, permission=GROUP_ADMIN |
                  GROUP_OWNER | PRIVATE_FRIEND | SUPERUSER,)
